...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        homeItem.post { BottomNavAnimation.animateNavigationItem(homeItem) }
    }
    ...
    private fun observeViewModel() {
        ...
        viewModel.reminders.observe(this) { reminders ->
            ...
            if (next != null) {
                binding.tvNextReminderTime.text =
                    String.format("%02d:%02d • Drink %d ml", next.hour, next.minute, next.amount)
            } else {
                binding.tvNextReminderTime.text = "No active reminder"
            }
        }
    }
    ...
    inner class ScheduleAdapter : RecyclerView.Adapter<ScheduleAdapter.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val itemBinding = ItemScheduleBinding.inflate(
        ...
        inner class ViewHolder(
            ...
            fun bind(item: HistoryEntity) {
                ...
                itemBinding.ivStatus.setImageResource(R.drawable.ic_water_drop)
            }
        }
    }
}
